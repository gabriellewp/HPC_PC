...
{
  double tmp[NUMBER_OF_PADDED_DOFS] = {}; // zero initialisation
  ...
  for (unsigned der = 1; der < CONVERGENCE_ORDER; ++der) {  
    ...
    opt_DGEMM1(  NUMBER_OF_BASIS_FUNCTIONS, NUMBER_OF_QUANTITIES, NUMBER_OF_BASIS_FUNCTIONS,
    ...
    opt_DGEMM4A(  NUMBER_OF_BASIS_FUNCTIONS, NUMBER_OF_QUANTITIES, NUMBER_OF_QUANTITIES,
            globals.c4, tmp, NUMBER_OF_BASIS_FUNCTIONS,
    ...
    opt_DGEMM4B(  NUMBER_OF_BASIS_FUNCTIONS, NUMBER_OF_QUANTITIES, NUMBER_OF_QUANTITIES,
            globals.c5, tmp, NUMBER_OF_BASIS_FUNCTIONS,
                            ...
                            DegreesOfFreedom&       degreesOfFreedom )
{
  ...
  opt_DGEMM4A(  NUMBER_OF_BASIS_FUNCTIONS, NUMBER_OF_QUANTITIES, NUMBER_OF_QUANTITIES,
          globals.c6, tmp, NUMBER_OF_BASIS_FUNCTIONS,
          A, NUMBER_OF_QUANTITIES,
  ...
  opt_DGEMM4B(  NUMBER_OF_BASIS_FUNCTIONS, NUMBER_OF_QUANTITIES, NUMBER_OF_QUANTITIES,
          globals.c7, tmp, NUMBER_OF_BASIS_FUNCTIONS,
          B, NUMBER_OF_QUANTITIES,
          1.0, degreesOfFreedom, NUMBER_OF_BASIS_FUNCTIONS );
}
                  ...
                  DegreesOfFreedom        degreesOfFreedom )
{
  ...
  opt_DGEMM2(  NUMBER_OF_BASIS_FUNCTIONS, NUMBER_OF_QUANTITIES, NUMBER_OF_QUANTITIES,

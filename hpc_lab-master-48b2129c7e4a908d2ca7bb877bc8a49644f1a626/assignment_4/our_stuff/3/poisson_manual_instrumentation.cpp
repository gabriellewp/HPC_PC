...
{
	SCOREP_USER_REGION_DEFINE( handle_g_dot_product );
	
	double tmp = 0.0;

	SCOREP_USER_REGION_BEGIN( handle_g_dot_product, "g_dot_product", SCOREP_USER_REGION_TYPE_COMMON );
	...
	SCOREP_USER_REGION_END( handle_g_dot_product );
...
{
	SCOREP_USER_REGION_DEFINE( handle_g_scale );

	SCOREP_USER_REGION_BEGIN( handle_g_scale, "g_scale", SCOREP_USER_REGION_TYPE_COMMON );
	...
	SCOREP_USER_REGION_END( handle_g_scale );
}
...
{
	SCOREP_USER_REGION_DEFINE( handle_g_scale_add );

	SCOREP_USER_REGION_BEGIN( handle_g_scale_add, "g_scale_add", SCOREP_USER_REGION_TYPE_COMMON );
	...
	SCOREP_USER_REGION_END( handle_g_scale_add );
}
...
{
	SCOREP_USER_REGION_DEFINE( handle_g_product_operator_comm );
	SCOREP_USER_REGION_DEFINE( handle_g_product_operator_calc );
	
	SCOREP_USER_REGION_BEGIN( handle_g_product_operator_comm, "g_product_operator_comm", SCOREP_USER_REGION_TYPE_COMMON );
	...
	SCOREP_USER_REGION_END( handle_g_product_operator_comm );
	
	double mesh_width = 1.0/((double)(grid_points_1d-1));

	SCOREP_USER_REGION_BEGIN( handle_g_product_operator_calc, "g_product_operator_calc", SCOREP_USER_REGION_TYPE_COMMON );
	...
	SCOREP_USER_REGION_END( handle_g_product_operator_calc );
}
...
{
	SCOREP_USER_REGION_DEFINE( handle_solve_distr );
	SCOREP_USER_REGION_DEFINE( handle_solve_solving );
	SCOREP_USER_REGION_DEFINE( handle_solve_collect );
	...
	SCOREP_USER_REGION_BEGIN( handle_solve_distr, "solve_distr", SCOREP_USER_REGION_TYPE_COMMON );
	...
	SCOREP_USER_REGION_END( handle_solve_distr );
	...
	SCOREP_USER_REGION_BEGIN( handle_solve_solving, "solve_solving", SCOREP_USER_REGION_TYPE_COMMON );
	...
	SCOREP_USER_REGION_END( handle_solve_solving );
	
	SCOREP_USER_REGION_BEGIN( handle_solve_collect, "solve_collect", SCOREP_USER_REGION_TYPE_COMMON );
	...
	SCOREP_USER_REGION_END( handle_solve_collect );
}
